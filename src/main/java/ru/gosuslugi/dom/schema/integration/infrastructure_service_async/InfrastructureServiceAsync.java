 ...
 * 
 */
@WebServiceClient(name = "InfrastructureServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/infrastructure-service-async/", wsdlLocation = "http://localhost/")
public class InfrastructureServiceAsync
    extends Service
{

    private static final URL INFRASTRUCTURESERVICEASYNC_WSDL_LOCATION;
    private static final WebServiceException INFRASTRUCTURESERVICEASYNC_EXCEPTION;
    private static final QName INFRASTRUCTURESERVICEASYNC_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/infrastructure-service-async/", "InfrastructureServiceAsync");
