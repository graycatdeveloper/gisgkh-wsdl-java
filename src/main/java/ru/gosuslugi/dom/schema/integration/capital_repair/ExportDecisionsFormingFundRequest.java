 ...
 *         </sequence>
 *       </choice>
 *       <attribute ref="{http://dom.gosuslugi.ru/schema/integration/base/}version use="required" fixed="11.3.0.3""/>
 *     </extension>
 *   </complexContent>
 * </complexType>
 * }</pre>
    ...
    extends BaseType
{
    ...
    /**
     * Идентификатор решения о выборе способа формирования фонда капитального ремонта в ГИС ЖКХ
     * 
     */
