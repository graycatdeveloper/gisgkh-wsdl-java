 ...
 * Предписание (экспорт)
 * 
 * <p>Java class for exportPreceptType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="exportPreceptType">
 *   <complexContent>
...
@XmlType(name = "exportPreceptType", propOrder = {
    "number",
    "date",
    "deadline",
    "fiasHouseGUID",
...
public class ExportPreceptType {
