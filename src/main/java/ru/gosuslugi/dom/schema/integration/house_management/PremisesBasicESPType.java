...
/**
 * Базовый тип помещения (для импорта от ЕСП)
 * 
 * <p>Java class for PremisesBasicESPType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="PremisesBasicESPType">
 *   <complexContent>
...
@XmlType(name = "PremisesBasicESPType", propOrder = {
    "premisesNum",
    "ogfData",
    "informationConfirmed"
})
@XmlSeeAlso({
    ResidentialPremisesESPType.class,
    NonResidentialPremisesESPType.class
})
public class PremisesBasicESPType
