 ...
 * 
 * <p>Java class for GKN_EGRP_KeyRSOType complex type</p>.
 * 
...
public class GKNEGRPKeyRSOType {
    ...
    /**
     * Признак отсутствия у РСО, импортирующего дом, сведений о кадастровом номере и других ключей, позволяющих установить связь с ГКН/ЕГРП. При указании в ГИС ЖКХ не сохраняется информация ни о кадастровом номере, ни о его отсутствии. При изменении объекта, привязанного к ГКН или ЕГРП, объект не отвязывается.
     * 
     */
