 ...
 * Сведения об отмене
 * 
 * <p>Java class for ExportCancelledInfoWithAttachmentsType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ExportCancelledInfoWithAttachmentsType">
 *   <complexContent>
...
@XmlType(name = "ExportCancelledInfoWithAttachmentsType", propOrder = {
    "reason",
    "date",
    "number",
    "organisation",
...
public class ExportCancelledInfoWithAttachmentsType {
