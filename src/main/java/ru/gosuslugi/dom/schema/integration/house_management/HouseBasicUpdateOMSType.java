 ...
 * 
 * <p>Java class for HouseBasicUpdateOMSType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="HouseBasicUpdateOMSType">
 *   <complexContent>
...
@XmlType(name = "HouseBasicUpdateOMSType", propOrder = {
    "fiasHouseGuid",
    "totalSquare",
    "state",
    "lifeCycleStage",
...
public class HouseBasicUpdateOMSType
