...
/**
 * Тип данных, описывающий результаты экспорта сведений о гражданине, у которого имеется задолженность, подтвержденная судебным актом
 * 
 * <p>Java class for ExportDebtorResultType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ExportDebtorResultType">
 *   <complexContent>
...
@XmlType(name = "ExportDebtorResultType", propOrder = {
    "surName",
    "firstName",
    "patronymic",
    "inn",
...
public class ExportDebtorResultType {
    ...
    protected ExportDebtorResultType.IdentityDocument identityDocument;
     ...
     * @return
     *     possible object is
     *     {@link ExportDebtorResultType.IdentityDocument }
     *     
     */
    public ExportDebtorResultType.IdentityDocument getIdentityDocument() {
     ...
     */
    public void setIdentityDocument(ExportDebtorResultType.IdentityDocument value) {
