 ...
 * 
 * <p>Java class for importContractResultType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="importContractResultType">
 *   <complexContent>
...
@XmlType(name = "importContractResultType", propOrder = {
    "error"
})
public class ImportContractResultType
