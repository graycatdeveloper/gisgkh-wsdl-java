 ...
 *           <element name="RegulatedOrganization" type="{http://dom.gosuslugi.ru/schema/integration/organizations-registry-base/}RegOrgType" maxOccurs="1000" minOccurs="0"/>
...
@XmlRootElement(name = "exportMunicipalResourceTariffRequest")
public class ExportMunicipalResourceTariffRequest
    extends BaseType
{
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the regulatedOrganization property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the regulatedOrganization property.
     */
    public List<RegOrgType> getRegulatedOrganization() {
        if (regulatedOrganization == null) {
            regulatedOrganization = new ArrayList<>();
        }
