 ...
 * 
 * <p>Java class for PlannedExaminationType complex type</p>.
 * 
...
public class PlannedExaminationType {
    ...
    /**
     * Учетный номер проверки в Едином реестре проверок. Обязательно заполняется, если план должен быть зарегистрирован в Еlдином реестре проверок
     * 
     */
    @XmlElement(name = "URIRegistrationNumber")
    protected String uriRegistrationNumber;
    /**
     * Дата присвоения учетного номера проверки. Обязательно заполняется, если план должен быть зарегистрирован в Едином реестре проверок
     * 
     */
    ...
    public static class PlannedExaminationInfo {
        ...
        /**
         * Срок проведения плановой проверки.                 Должно быть обязательно заполнено хотя бы одно из полей tns:WorkDays или tns:WorkHours
         * 
         */
