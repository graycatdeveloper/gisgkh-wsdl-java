 ...
 * 
 * <p>Java class for BlockUpdateUOType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="BlockUpdateUOType">
 *   <complexContent>
...
@XmlType(name = "BlockUpdateUOType", propOrder = {
    "blockNum",
...
public class BlockUpdateUOType
