 ...
 * 
 * <p>Java class for ElectricCurrentMeteringValueExportType complex type</p>.
 * 
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.device_metering.ExportMeteringDeviceHistoryResultType.ElectricDeviceValue.Values.CurrentValue.class
})
