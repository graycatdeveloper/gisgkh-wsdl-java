 ...
 * 
 * <p>Java class for ExportExaminationResultsType complex type</p>.
 * 
...
public class ExportExaminationResultsType {
     ...
     * 
     * НСИ "Типа адреса в инспектировании"
     * 
     */
    ...
    public static class IdentifiedOffencesInfo {
        ...
        /**
         * Наименование органа, в который направлены материалы о выявленных нарушениях
         * 
         */
