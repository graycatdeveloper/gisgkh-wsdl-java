...
/**
 * Жилое помещение (обновление данных для ЕСП)
 * 
 * <p>Java class for ResidentialPremisesUpdateESPType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ResidentialPremisesUpdateESPType">
 *   <complexContent>
...
@XmlType(name = "ResidentialPremisesUpdateESPType", propOrder = {
    "entranceNum",
    "hasNoEntrance",
    "fiasChildHouseGuid",
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.house_management.ImportHouseESPRequest.ApartmentHouse.ResidentialPremises.ResidentialPremisesToUpdate.class
})
public class ResidentialPremisesUpdateESPType
