 ...
 * 
 */
@WebServiceClient(name = "NsiServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/nsi-service-async/", wsdlLocation = "http://localhost/")
    ...
    extends Service
{
    ...
    private static final QName NSISERVICEASYNC_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/nsi-service-async/", "NsiServiceAsync");
