 ...
 * 
 * <p>Java class for ResidentialPremisesUsageType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ResidentialPremisesUsageType">
 *   <complexContent>
...
@XmlType(name = "ResidentialPremisesUsageType", propOrder = {
    "price",
    "differentiation",
...
public class ResidentialPremisesUsageType
