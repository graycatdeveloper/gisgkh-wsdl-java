...
/**
 * Блок дома блокированной застройки  (для импорта от УО)
 * 
 * <p>Java class for BlockUOType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="BlockUOType">
 *   <complexContent>
...
@XmlType(name = "BlockUOType", propOrder = {
    "blockNum",
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.house_management.ImportHouseUORequest.LivingHouse.Blocks.BlockToCreate.class
})
public class BlockUOType
