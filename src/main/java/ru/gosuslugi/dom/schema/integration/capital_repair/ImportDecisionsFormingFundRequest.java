    ...
    extends BaseType
{
    ...
    /**
     * Импортируемые сведения о решении о выборе способа формирования фонда капитального ремонта
     * 
     */
    ...
    public static class ImportDecision {
        ...
        /**
         * Транспортный идентификатор  для выполнения операции с решением
         * 
         */
        @XmlElement(name = "TransportGuid", required = true)
        protected String transportGuid;
        /**
         * Создание решения о выборе способа формирования фонда капитального ремонта с последующим размещением в ГИС ЖКХ
         * 
         */
        @XmlElement(name = "LoadDecision")
        protected ImportDecisionsFormingFundRequest.ImportDecision.LoadDecision loadDecision;
        /**
         * Аннулирование решения о выборе способа формирования фонда капитального ремонта
         * 
         */
