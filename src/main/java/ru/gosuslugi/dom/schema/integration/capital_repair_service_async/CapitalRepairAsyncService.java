 ...
 * 
 */
@WebServiceClient(name = "CapitalRepairAsyncService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/capital-repair-service-async/", wsdlLocation = "http://localhost/")
public class CapitalRepairAsyncService
    extends Service
{

    private static final URL CAPITALREPAIRASYNCSERVICE_WSDL_LOCATION;
    private static final WebServiceException CAPITALREPAIRASYNCSERVICE_EXCEPTION;
    private static final QName CAPITALREPAIRASYNCSERVICE_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/capital-repair-service-async/", "CapitalRepairAsyncService");
