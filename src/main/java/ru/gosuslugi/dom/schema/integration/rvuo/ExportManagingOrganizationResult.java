...
@XmlRootElement(name = "exportManagingOrganizationResult")
public class ExportManagingOrganizationResult
    extends BaseType
{

    /**
     * Результат выполнения запроса на экспорт информации об управляющих организациях
     * 
     */
