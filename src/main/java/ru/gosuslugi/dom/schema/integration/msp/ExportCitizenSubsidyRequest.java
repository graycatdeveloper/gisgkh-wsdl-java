    ...
    extends BaseType
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the citizenSubsidyGuid property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the citizenSubsidyGuid property.
     */
    public List<String> getCitizenSubsidyGuid() {
        if (citizenSubsidyGuid == null) {
            citizenSubsidyGuid = new ArrayList<>();
        }
