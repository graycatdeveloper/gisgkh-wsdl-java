...
/**
 * Комната (обновление данных для ЕСП)
 * 
 * <p>Java class for RoomUpdateESPType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="RoomUpdateESPType">
 *   <complexContent>
...
@XmlType(name = "RoomUpdateESPType", propOrder = {
    "roomNumber",
    "square",
    "ogfData",
    "annulmentReason",
