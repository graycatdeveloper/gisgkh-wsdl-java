...
/**
 * <p>Java class for DateDetailsType complex type</p>.
 * 
 ...
 *           </complexType>
 *         </element>
 *         <element name="PaymentDocumentInterval">
 *           <complexType>
 *             <complexContent>
 *               <restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 <sequence>
...
public class DateDetailsType {
     ...
     * 
     */
    @XmlElement(name = "PeriodMetering", required = true)
     ...
     * 
     */
    @XmlElement(name = "PaymentDocumentInterval", required = true)
    protected DateDetailsType.PaymentDocumentInterval paymentDocumentInterval;
    /**
     * Срок внесения платы за жилое помещение и (или) коммунальные услуги
     * 
     */
    @XmlElement(name = "PaymentInterval", required = true)
    protected DateDetailsType.PaymentInterval paymentInterval;
     ...
     * @return
     *     possible object is
     *     {@link DateDetailsType.PaymentDocumentInterval }
     *     
     */
    public DateDetailsType.PaymentDocumentInterval getPaymentDocumentInterval() {
     ...
     */
    public void setPaymentDocumentInterval(DateDetailsType.PaymentDocumentInterval value) {
     ...
     * @return
     *     possible object is
     *     {@link DateDetailsType.PaymentInterval }
     *     
     */
    public DateDetailsType.PaymentInterval getPaymentInterval() {
     ...
     */
    public void setPaymentInterval(DateDetailsType.PaymentInterval value) {
