...
/**
 * Подъезд (обновление данных для ЕСП)
 * 
 * <p>Java class for EntranceUpdateESPType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="EntranceUpdateESPType">
 *   <complexContent>
...
@XmlType(name = "EntranceUpdateESPType", propOrder = {
    "entranceNum",
    "fiasChildHouseGuid",
    "storeysCount",
    "creationYear",
...
public class EntranceUpdateESPType {
