...
import ru.gosuslugi.dom.schema.integration.house_management.ExportOwnerDecisionRequest;
import ru.gosuslugi.dom.schema.integration.house_management.ExportOwnerRefusalRequest;
...
import ru.gosuslugi.dom.schema.integration.house_management.ExportVotingMessageRequest;
...
import ru.gosuslugi.dom.schema.integration.house_management.ImportExternalVotingProtocolRequest;
...
import ru.gosuslugi.dom.schema.integration.house_management.ImportOwnerDecisionRequest;
import ru.gosuslugi.dom.schema.integration.house_management.ImportOwnerRefusalRequest;
...
import ru.gosuslugi.dom.schema.integration.house_management.ImportVotingMessageRequest;
...
public interface HouseManagementPortsTypeAsync {
    ...
    /**
     * Импорт решения собственника по вопросам голосования
     * 
     * @param importOwnerDecisionRequest
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.base.AckRequest
     * @throws Fault
     */
    @WebMethod(action = "urn:importOwnerDecision")
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/base/", partName = "AckRequest")
    public AckRequest importOwnerDecision(
        @WebParam(name = "importOwnerDecisionRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/house-management/", partName = "importOwnerDecisionRequest")
        ImportOwnerDecisionRequest importOwnerDecisionRequest)
        throws Fault
    ;

    /**
     * Экспорт решений собственников по вопросам голосования
     * 
     * @param exportOwnerDecisionRequest
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.base.AckRequest
     * @throws Fault
     */
    @WebMethod(action = "urn:exportOwnerDecision")
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/base/", partName = "AckRequest")
    public AckRequest exportOwnerDecision(
        @WebParam(name = "exportOwnerDecisionRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/house-management/", partName = "exportOwnerDecisionRequest")
        ExportOwnerDecisionRequest exportOwnerDecisionRequest)
        throws Fault
    ;
     ...
     * 
     * @param exportBriefSupplyResourceContractRequest
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.base.AckRequest
     * @throws Fault
     */
    @WebMethod(action = "urn:exportBriefSupplyResourceContract")
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/base/", partName = "AckRequest")
    public AckRequest exportBriefSupplyResourceContract(
        @WebParam(name = "exportBriefSupplyResourceContractRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/house-management/", partName = "exportBriefSupplyResourceContractRequest")
        ExportBriefSupplyResourceContractRequest exportBriefSupplyResourceContractRequest)
        throws Fault
    ;

    /**
     * Экспорт краткой информации о договоре найма
     * 
     * @param exportBriefSocialHireContractRequest
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.base.AckRequest
     * @throws Fault
     */
    @WebMethod(action = "urn:exportBriefSocialHireContract")
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/base/", partName = "AckRequest")
    public AckRequest exportBriefSocialHireContract(
        @WebParam(name = "exportBriefSocialHireContractRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/house-management/", partName = "exportBriefSocialHireContractRequest")
        ExportBriefSocialHireContractRequest exportBriefSocialHireContractRequest)
        throws Fault
    ;
     ...
     * Операция сноса дома
     * 
     * @param demolishHouseRequest
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.base.AckRequest
     * @throws Fault
     */
    @WebMethod(action = "urn:demolishHouse")
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/base/", partName = "AckRequest")
    ...
    /**
     * Импорт итогов голосования, проведенного с использованием системы, отличной от ГИС ЖКХ
     * 
     * @param importExternalVotingProtocolRequest
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.base.AckRequest
     * @throws Fault
     */
    @WebMethod(action = "urn:importExternalVotingProtocol")
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/base/", partName = "AckRequest")
    public AckRequest importExternalVotingProtocol(
        @WebParam(name = "importExternalVotingProtocolRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/house-management/", partName = "importExternalVotingProtocolRequest")
        ImportExternalVotingProtocolRequest importExternalVotingProtocolRequest)
        throws Fault
    ;

    /**
     * Импорт сообщения о проведении ОСС
     * 
     * @param importVotingMessagenRequest
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.base.AckRequest
     * @throws Fault
     */
    @WebMethod(action = "urn:importVotingMessage")
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/base/", partName = "AckRequest")
    public AckRequest importVotingMessage(
        @WebParam(name = "importVotingMessageRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/house-management/", partName = "importVotingMessagenRequest")
        ImportVotingMessageRequest importVotingMessagenRequest)
        throws Fault
    ;
     ...
     * 
     * @param exportVotingMessageRequest
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.base.AckRequest
     * @throws Fault
     */
    @WebMethod(action = "urn:exportVotingMessage")
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/base/", partName = "AckRequest")
    public AckRequest exportVotingMessage(
        @WebParam(name = "exportVotingMessageRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/house-management/", partName = "exportVotingMessageRequest")
        ExportVotingMessageRequest exportVotingMessageRequest)
        throws Fault
    ;

    /**
     * Импорт письменных отказов собственников
     * 
     * @param importOwnerRefusalRequest
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.base.AckRequest
     * @throws Fault
     */
    @WebMethod(action = "urn:importOwnerRefusal")
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/base/", partName = "AckRequest")
    public AckRequest importOwnerRefusal(
        @WebParam(name = "importOwnerRefusalRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/house-management/", partName = "importOwnerRefusalRequest")
        ImportOwnerRefusalRequest importOwnerRefusalRequest)
        throws Fault
    ;

    /**
     * Экспорт письменных отказов собственников
     * 
     * @param exportOwnerRefusalRequest
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.base.AckRequest
     * @throws Fault
     */
    @WebMethod(action = "urn:exportOwnerRefusal")
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/base/", partName = "AckRequest")
    public AckRequest exportOwnerRefusal(
        @WebParam(name = "exportOwnerRefusalRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/house-management/", partName = "exportOwnerRefusalRequest")
        ExportOwnerRefusalRequest exportOwnerRefusalRequest)
        throws Fault
    ;
