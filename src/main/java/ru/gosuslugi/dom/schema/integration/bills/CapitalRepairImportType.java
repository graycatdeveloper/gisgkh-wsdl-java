...
/**
 * <p>Java class for CapitalRepairImportType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="CapitalRepairImportType">
 *   <complexContent>
...
@XmlType(name = "CapitalRepairImportType", propOrder = {
    "contribution",
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.bills.PaymentDocumentType.CapitalRepairCharge.class
})
public class CapitalRepairImportType {
    ...
    /**
     * ИТОГО К ОПЛАТЕ, руб. (с учетом задолженности/аванса, неустоек и судебных расходов).
     * Ссылка на приложение к приказу Минстроя РФ от 26.01.2018 N 43/пр - Раздел 3 примерной формы ПД
     * 
     */
    ...
    protected CapitalRepairImportType.PaymentRecalculation paymentRecalculation;
    /**
     ...
     * @return
     *     possible object is
     *     {@link CapitalRepairImportType.PaymentRecalculation }
     *     
     */
    public CapitalRepairImportType.PaymentRecalculation getPaymentRecalculation() {
     ...
     */
    public void setPaymentRecalculation(CapitalRepairImportType.PaymentRecalculation value) {
