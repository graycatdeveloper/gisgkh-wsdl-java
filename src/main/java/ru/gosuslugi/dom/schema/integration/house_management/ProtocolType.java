...
public class ProtocolType {
    ...
    /**
     * Заочное голосование с использованием системы. Не используется для импорта протоколов
     * 
     */
     ...
     * 
     * По умолчанию устанавливается значение "Собрание собственников", если не заполнено
     * 
     */
    ...
    public static class AVoting {
         ...
         * Обязательно для заполнения, если заполнен элемент tns:Placing.
         * 
         */
    ...
    public static class DecisionList {
        ...
        protected ProtocolType.DecisionList.HomeownersDecisionsType homeownersDecisionsType;
        /**
         * Есть в уставе
         * 
         */
         ...
         * @return
         *     possible object is
         *     {@link ProtocolType.DecisionList.HomeownersDecisionsType }
         *     
         */
        public ProtocolType.DecisionList.HomeownersDecisionsType getHomeownersDecisionsType() {
         ...
         */
        public void setHomeownersDecisionsType(ProtocolType.DecisionList.HomeownersDecisionsType value) {
