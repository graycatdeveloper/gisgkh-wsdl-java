    ...
    extends BaseType
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the supplierNotificationOfOrderExecution property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the supplierNotificationOfOrderExecution property.
     */
    public List<ImportSupplierNotificationsOfOrderExecutionRequest.SupplierNotificationOfOrderExecution> getSupplierNotificationOfOrderExecution() {
        if (supplierNotificationOfOrderExecution == null) {
            supplierNotificationOfOrderExecution = new ArrayList<>();
        }
