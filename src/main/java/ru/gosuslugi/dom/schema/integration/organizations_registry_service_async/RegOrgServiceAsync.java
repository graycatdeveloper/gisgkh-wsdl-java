 ...
 * 
 */
@WebServiceClient(name = "RegOrgServiceAsync", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/organizations-registry-service-async/", wsdlLocation = "http://localhost/")
    ...
    extends Service
{
    ...
    private static final QName REGORGSERVICEASYNC_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/organizations-registry-service-async/", "RegOrgServiceAsync");
