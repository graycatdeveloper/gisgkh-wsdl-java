...
/**
 * Лифт (для импорта от ЕСП)
 * 
 * <p>Java class for LiftESPType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="LiftESPType">
 *   <complexContent>
...
@XmlType(name = "LiftESPType", propOrder = {
    "entranceNum",
    "fiasChildHouseGuid",
    "factoryNum",
    "type",
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.house_management.ImportHouseESPRequest.ApartmentHouse.LiftToCreate.class
})
public class LiftESPType {
