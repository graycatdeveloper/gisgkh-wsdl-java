...
/**
 * Тип данных, описывающий реквизиты акта в результатах экспорте
 * 
 * <p>Java class for ActDetailsExportType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ActDetailsExportType">
 *   <complexContent>
...
@XmlType(name = "ActDetailsExportType", propOrder = {
    "actGUID",
    "actType",
    "actNumber",
    "actDate",
...
public class ActDetailsExportType {
