 ...
 * 
 * <p>Java class for ResidentialPremisesExportType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ResidentialPremisesExportType">
 *   <complexContent>
...
@XmlType(name = "ResidentialPremisesExportType", propOrder = {
    "entranceNum",
    "hasNoEntrance",
    "fiasChildHouseGuid",
...
@XmlSeeAlso({
    ru.gosuslugi.dom.schema.integration.house_management.ExportHouseResultType.ApartmentHouse.ResidentialPremises.class
})
public class ResidentialPremisesExportType
