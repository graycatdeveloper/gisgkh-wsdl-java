...
import ru.gosuslugi.dom.schema.integration.base.GetRequestsStateRequest;
import ru.gosuslugi.dom.schema.integration.base.GetRequestsStateResult;
...
public interface BillsPortsTypeAsync {
     ...
     * 
     * @param getRequestsStateRequest
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.base.GetRequestsStateResult
     * @throws Fault
     */
    @WebMethod(action = "urn:getRequestsState")
    @WebResult(name = "getRequestsStateResult", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/base/", partName = "getRequestsStateResult")
    public GetRequestsStateResult getRequestsState(
        @WebParam(name = "getRequestsStateRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/base/", partName = "getRequestsStateRequest")
        GetRequestsStateRequest getRequestsStateRequest)
        throws Fault
    ;
