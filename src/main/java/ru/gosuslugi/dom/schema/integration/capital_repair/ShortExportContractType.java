...
/**
 * Экспортируемый договор на выполнение работ (оказание услуг) по капитальному ремонту (без статусов и идентификаторов)
 * 
 * <p>Java class for ShortExportContractType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="ShortExportContractType">
 *   <complexContent>
...
@XmlType(name = "ShortExportContractType", propOrder = {
    "number",
    "date",
    "startDate",
    "endDate",
...
@XmlSeeAlso({
    ExportContractType.class
})
public class ShortExportContractType {
