 ...
 * 
 */
@WebServiceClient(name = "MSPAsyncService", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/msp-service-async/", wsdlLocation = "http://localhost/")
public class MSPAsyncService
    extends Service
{

    private static final URL MSPASYNCSERVICE_WSDL_LOCATION;
    private static final WebServiceException MSPASYNCSERVICE_EXCEPTION;
    private static final QName MSPASYNCSERVICE_QNAME = new QName("http://dom.gosuslugi.ru/schema/integration/msp-service-async/", "MSPAsyncService");
