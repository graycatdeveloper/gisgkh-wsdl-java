...
import ru.gosuslugi.dom.schema.integration.services.ExportQualityAssessmentRequest;
...
import ru.gosuslugi.dom.schema.integration.services.ImportQualityAssessmentRequest;
...
public interface ServicesPortsTypeAsync {
    ...
    /**
     * Импорт сведений об оценке качества
     * 
     * @param importQualityAssessmentRequest
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.base.AckRequest
     * @throws Fault
     */
    @WebMethod(action = "urn:importQualityAssessment")
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/base/", partName = "AckRequest")
    public AckRequest importQualityAssessment(
        @WebParam(name = "importQualityAssessmentRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/services/", partName = "importQualityAssessmentRequest")
        ImportQualityAssessmentRequest importQualityAssessmentRequest)
        throws Fault
    ;

    /**
     * Экспорт сведений об оценке качества
     * 
     * @param exportQualityAssessmentRequest
     * @return
     *     returns ru.gosuslugi.dom.schema.integration.base.AckRequest
     * @throws Fault
     */
    @WebMethod(action = "urn:exportQualityAssessment")
    @WebResult(name = "AckRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/base/", partName = "AckRequest")
    public AckRequest exportQualityAssessment(
        @WebParam(name = "exportQualityAssessmentRequest", targetNamespace = "http://dom.gosuslugi.ru/schema/integration/services/", partName = "exportQualityAssessmentRequest")
        ExportQualityAssessmentRequest exportQualityAssessmentRequest)
        throws Fault
    ;
